...
export default function FeaturedProjects({ openProject, navigateTo }) {
  return (
    <section className="py-24 px-6 bg-zinc-900/20">
        <div className="max-w-6xl mx-auto">
            <div className="flex justify-between items-end mb-16">
                ...
                <a href="#" onClick={(e) => { e.preventDefault(); navigateTo('projects'); }} className="text-sm font-bold text-orange-500 hover:text-white transition group">
            ...
            <div className="grid md:grid-cols-2 gap-8">
                {/* Derana */}
                <div onClick={() => openProject('derana')} className="project-card p-8 bg-zinc-900/50 border border-zinc-800 rounded-[2.5rem] relative overflow-hidden group">
                ...
                {/* NDB Bank */}
                <div onClick={() => openProject('ndb')} className="project-card p-8 bg-zinc-900/50 border border-zinc-800 rounded-[2.5rem] relative overflow-hidden group">
